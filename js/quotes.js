...
//5.0 quotes : Math.random/ceil/floor,round

const quote = document.querySelector("#greeting_quotes span:first-child");
const author = document.querySelector("#greeting_quotes span:last-child");

const todaysQuote = quotes[Math.floor(Math.random() * quotes.length)];

// quote[num of floor(num of random)* quotes.lenght]
